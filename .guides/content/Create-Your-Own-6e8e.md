...
- What's the game called? What's the story?
- Does the start screen set the tone?
...
{Check It!|assessment}(llm-based-auto-rubric-894835945)
...
Use **Screencastify Submit** to record a short video (1-2 minutes) walking through your design choices.

Show:
1. Your **start screen** — what does it communicate?
